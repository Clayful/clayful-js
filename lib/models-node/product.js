...
module.exports = request => {
	...
	const Product = {
		name: 'Product',
		path: 'products',
		adjustVariantQuantity: function() {
			return request(assign(Product._adjustVariantQuantity(), { args: Array.prototype.slice.call(arguments) }));
		},
		count: function() {
		...
		markAsCensored: function() {
			return request(assign(Product._markAsCensored(), { args: Array.prototype.slice.call(arguments) }));
		},
		markAsUncensored: function() {
			return request(assign(Product._markAsUncensored(), { args: Array.prototype.slice.call(arguments) }));
		},
	...
	Product._adjustVariantQuantity = function() {

		return {
			modelName:      Product.name,
			methodName:     'adjustVariantQuantity',
			httpMethod:     'POST',
	...
	Product._markAsCensored = function() {
	...
	Product._markAsUncensored = function() {
