...
describe('Clayful', () => {
	...
	describe(`.formatNumber()`, () => {
		...
		it(`should return the original number as a string`, () => {
			...
			const num = 1000000.25;

			expect(Clayful.formatNumber(num)).to.be('1000000.25');
			expect(Clayful.formatNumber(num, {})).to.be('1000000.25');
		...
		it(`should return a formatted number`, () => {
			...
			cases.forEach(c => {
				expect(Clayful.formatNumber(num, c.options)).to.be(c.out);
			});
	...
	describe(`.formatPrice()`, () => {
		...
		it(`should return the original number as a string`, () => {
			...
			expect(Clayful.formatPrice(num)).to.be('1000000.25');
			expect(Clayful.formatPrice(num, {})).to.be('1000000.25');
