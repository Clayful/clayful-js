...
Clayful.extractRequestArguments = options => {
	...
	/**
	 * (...params, { query, ...headerOptions }, callback)
	 * where query, ...headerOptions are optional (if the endpoint doesn't have any params, ...params are also optional)
	 */
	...
	/**
	 * (...params, payload, { query, ...headerOptions }, callback)
	 * where payload, query, ...headerOptions are optional (if the endpoint doesn't have any params, ...params are also optional)
	 */
